...
export default function Courses() {
    return (
        <section className=" bg-white" aria-labelledby="courses-heading">
            <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-5 grid gap-8 md:grid-cols-3">
                    {[
                        ...
                        <Card
                            key={idx}
                            className="group relative overflow-hidden bg-[#19222b] shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 hover:border-[#6941C6]/50"
                        >
