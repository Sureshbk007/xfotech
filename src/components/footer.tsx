            ...
            <div className="container mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="grid gap-8 md:grid-cols-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <nav className="space-y-2" aria-label="Footer navigation">
                            <Link
                                href="#"
                                className="block text-sm text-slate-400 transition-colors hover:text-[#A78BFA] focus:text-[#A78BFA] focus:outline-none"
                            >
                                Home
                            </Link>
                            <Link
                ...
                <div className="mt-12 border-t border-slate-800 pt-8">
                    <div className="flex flex-col items-center justify-between space-y-4 sm:flex-row sm:space-y-0">
                        <p className="text-sm text-slate-400">© {new Date().getFullYear()} TechPro. All rights reserved.</p>
                        <div className="flex space-x-6">
                            <Link
                                href="#"
                                className="text-sm text-slate-400 transition-colors hover:text-[#A78BFA] focus:text-[#A78BFA] focus:outline-none"
                            >
                                Privacy Policy
                            </Link>
                            <Link
